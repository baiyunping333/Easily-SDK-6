...
LOC_API void _gdi_draw_sector(visual_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, const xspan_t* prl, const xspan_t* prs, double from, double sweep);
LOC_API void _gdi_draw_pie(visual_t rdc, const xpen_t* pxp, const xbrush_t*pxb, const xrect_t* prt, double from, double sweep);
...
LOC_API void _gdiplus_draw_sector(visual_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, const xspan_t* prl, const xspan_t* prs, double from, double sweep);
LOC_API void _gdiplus_draw_pie(visual_t rdc, const xpen_t* pxp, const xbrush_t*pxb, const xrect_t* prt, double from, double sweep);
...
LOC_API void _cairo_draw_triangle(visual_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* prt, const tchar_t* orient);
...
LOC_API void _cairo_draw_sector(visual_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, const xspan_t* prl, const xspan_t* prs, double from, double sweep);
LOC_API void _cairo_draw_pie(visual_t rdc, const xpen_t* pxp, const xbrush_t*pxb, const xrect_t* prt, double from, double sweep);
...
#ifdef XDU_SUPPORT_CONTEXT_BITMAP
LOC_API void _cairo_draw_picture(visual_t rdc, const tchar_t* fname, const tchar_t* clr, const xrect_t* prt);
