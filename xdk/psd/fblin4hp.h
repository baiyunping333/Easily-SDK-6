...
static T8p sd(T8p d1, int s1, T8p d2, int s2)
// sd stands for shift data
{
	return((d1 << s1) | (d2 >> s2));
}

static T8p sdm(T8p d1, int s1, T8p d2, int s2, T8p m)
// sdm stands for shift data mask
{
	return(((d1 << s1) | (d2 >> s2))&m);
}

static T8p sdml(T8p d, int s, T8p m)
// sdml stands for shift data left mask
{
	return(m&(d << s));
}

static T8p sdmr(T8p d, int s, T8p m)
...
static void Blt_Shift_Positif_w0(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	M1 = M2&~M1;
	do
	{
...
static void Blt_Shift_Positif_w1(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	int S2 = 32 - S;
	M1 = ~M1;
	do
...
static void Blt_Shift_Positif_w2(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	int S2 = 32 - S;
	M1 = ~M1;
	do
...
static void Blt_Shift_Positif(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	int S2 = 32 - S;
	M1 = ~M1;
...
static void Blt_Shift_Null_w0(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	M1 |= ~M2;
	do
	{
...
static void Blt_Shift_Null_w1(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	do
	{
		*d++ = (*d&M1) | (*s++&~M1);
...
static void Blt_Shift_Null_w2(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	do
	{
		*d++ = (*d&M1) | (*s++&~M1);
...
static void Blt_Shift_Null_w3(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	do
	{
		*d++ = (*d&M1) | (*s++&~M1);
...
static void Blt_Shift_Null(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	do
	{
		int i;
...
static void Blt_Shift_Negatif_w0(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	int S2 = 32 + S;
	S = -S;
	M1 = M2&~M1;
...
static void Blt_Shift_Negatif_w1(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	int S2 = 32 + S;
	M1 = ~M1;
	S = -S;
...
static void Blt_Shift_Negatif_w2(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	int S2 = 32 + S;
	M1 = ~M1;
	ss--;
...
static void Blt_Shift_Negatif(P8p s, P8p d, int ss, int ds, int S, T8p M1, T8p M2, int w, int h)
{
	int S2 = 32 + S;
	M1 = ~M1;
	ss--;
