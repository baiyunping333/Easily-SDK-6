...
static bitmap_quad_t QUAD2[] = {
	{ 0x00, 0x00, 0x00, 0x00 },
	{ 0xFF, 0xFF, 0xFF, 0x00 },
};

static bitmap_quad_t QUAD16[] = {
	{ 0x00, 0x00, 0x00, 0x00 },
	{ 0x00, 0x00, 0x80, 0x00 },
	{ 0x00, 0x80, 0x00, 0x00 },
	{ 0x00, 0x80, 0x80, 0x00 },
...
bool_t xbmp_get_size(xsize_t* ps, const unsigned char* src, unsigned int len)
{
	unsigned char* pb;
...
bool_t xbmp_get_rgb(xcolor_t* pc, int row, int col, const unsigned char* src, unsigned int len)
{
	unsigned char* pb;
