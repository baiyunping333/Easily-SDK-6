...
void xdu_impl_context_graphic(if_context_t* pif)
{
	...
	pif->pf_gdi_draw_sector = _gdi_draw_sector;
	...
	pif->pf_gdi_draw_sector = _gdiplus_draw_sector;
	...
	pif->pf_gdi_draw_sector = _cairo_draw_sector;
	...
	pif->pf_gdi_draw_triangle = _cairo_draw_triangle;
