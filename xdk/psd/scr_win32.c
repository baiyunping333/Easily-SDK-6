...
#define APP_NAME _T("Microwindows")
...
win32_open(PSD psd)
{
	...
	HDC rootDC = CreateDC(_T("DISPLAY"), NULL, NULL, NULL);
...
#error "No support bpp < 16"
	...
	winRootWindow = CreateWindow(APP_NAME, _T(""), WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU, 0, 0,
	...
	if (winRootWindow) {
		...
		dummyEvent = CreateEvent(NULL, TRUE, FALSE, _T(""));
