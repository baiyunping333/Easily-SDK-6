...
typedef void(*PF_GDI_DRAW_SECTOR)(visual_t, const xpen_t*, const xbrush_t*, const xpoint_t*, const xspan_t*, const xspan_t*, double, double);
...
typedef struct _if_context_t{
	...
	PF_GDI_DRAW_SECTOR		pf_gdi_draw_sector;
