...
@RETURN void: none.
*/
LOC_API void	draw_pie_raw(visual_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* prt, double fang, double sang);
...
@RETURN void: none.
*/
LOC_API void	draw_pie(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* prt, double fang, double sang);
